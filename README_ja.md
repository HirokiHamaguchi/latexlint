...
**検出するルールは、好みや文体に合わせて選択することを強くお勧めします。** ルールの選択方法については、[LaTeX Lint: Choose Detection Rules](#latex-lint-choose-detection-rules)をご参照ください。
...
20. [LLMathPunctuation](#llmathpunctuation) (数式環境内の不適切な句読点を検出)
...
必要に応じて、[sample/lint.pdf](https://github.com/HirokiHamaguchi/latexlint/blob/master/sample/lint.pdf)も参照してください。
...
VS Code版では、主に動作の高速化のために、いくつかのパターンマッチングのみを使用して、誤りと思われるテキストを検出しています。
