...
\newcommand{\trNg}{\mathrm{tr}}
\newcommand{\trOk}{\operatorname{tr}}
\DeclareMathOperator{\trDeclare}{tr}
...
OK: An $\mathbb{R}$-valued.

\begin{minipage}{0.5\textwidth}
	\begin{itemize}
		\item NG: `a $\mathbb{R}$-valued` → OK: `an $\mathbb{R}$-valued`
...
\begin{gather*}
	...
	X_1 \wedge X_2 \quad
	\text{\tA{ok}} \\
	X_1 \oplus_{\mathbb{R}} X_2 \quad
	X_1 \oplus_R X_2 \quad
	\text{\tA{ok}} \\
...
Disabled by default. (It contains false positives, and may be too strict for some users.)
...
This difference become clearer with some other math fonts.
...
\begin{itembox}{We do NOT detect any of : in the following}
	...
	\begin{itemize}
		\item $f\colon X \to Y$, the correct use of \textbackslash{}colon.
...
Unicode: ……, dots: \dots, textellipsis: \textellipsis, dotso: \dotso
...
Without a backslash: e.g. blah i.e. blah a.k.a. blah i.i.d. blah w.r.t. blah w.l.o.g. blah resp. blah etc.\\
\phantom{out}With a backslash: e.g.\ blah i.e.\ blah a.k.a.\ blah i.i.d.\ blah w.r.t.\ blah w.l.o.g.\ blah resp.\ blah etc.
...
Improper spacing: x\(y\)z and x$y$z.
Proper spacing: x \(y\) z and x $y$ z.
