...
export const defaultConfig: LintConfig = Object.keys(configData).reduce((acc, key) => {
    acc[key as keyof LintConfig] = configData[key as keyof typeof configData].default;
    return acc;
}, {} as LintConfig);
